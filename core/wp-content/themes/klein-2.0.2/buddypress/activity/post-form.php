		...
		<div class="clearfix row" id="whats-new-options">
			...
			<div class="col-md-6">
				<div id="whats-new-submit" class="pull-left">
					<input class="btn btn-primary" type="submit" name="aw-whats-new-submit" id="aw-whats-new-submit" value="<?php _e( 'Post Update', 'buddypress' ); ?>" />
				</div>
			</div>
				...
				<div class="pull-right" id="whats-new-post-in-box">
					<div class="col-md-3">
						<div class="pull-right" id="post-in-label">
							<strong><?php _e( 'In', 'buddypress' ); ?>:</strong> 
						</div>
					</div>
