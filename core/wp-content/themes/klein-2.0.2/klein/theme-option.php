...
function custom_theme_options() {
  ...
  $gears_fb_membership = array(
    ...
    'settings'   => array(
				...
				array(
					'id'          => 'bp_layout',
					'label'       => 'BuddyPress Layout',
					'desc'        => 'Default layout for BuddyPress pages',
					'std'         => '',
					'type'        => 'select',
					'section'     => 'general',
					'class'       => '',
  ...
  if( class_exists( 'Gears' ) ){
		...
		$gears_fb_membership['sections'][] = array(
			'id'          => 'members',
			'title'       => 'Members'
		);
		
		$gears_fb_membership['settings'][] = array(
				'id'          => 'is_fb_enabled',
  ...
  if ( $saved_settings !== $gears_fb_membership ) {
		update_option( 'option_tree_settings', $gears_fb_membership ); 
  }
